...
agregar_ponderador_calibrado <- function(d, res_dir = "results/estimates") {
...
especificaciones_modelo_final <- function(res_dir = "results/estimates", termino_espacial = NULL) {
...
poblacion_adulta_municipal <- function(iter_csv = Sys.getenv("ITER_CSV",
    unset = "data/external/iter/conjunto_de_datos_iter_00CSV20.csv")) {
...
cargar_covariables_area <- function(datos, COV = "data/processed/covariates") {
