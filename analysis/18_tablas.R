...
nota_tabla2 <- "IC95%: intervalo de confianza al 95%. Las estimaciones BYM2 son probabilidades condicionales estandarizadas a la composición adulta censal; las directas usan los denominadores clínicos de la encuesta. BYM2: modelo espacial bayesiano Besag-York-Mollié tipo 2. HTA: hipertensión arterial. pp: puntos porcentuales."
...
cat("\n=== TABLA 3 ===\n"); print(tabla3)
cat("\nGuardado: results/tables/Tablas_1_2_3.xlsx (editable) + .csv individuales\n")
