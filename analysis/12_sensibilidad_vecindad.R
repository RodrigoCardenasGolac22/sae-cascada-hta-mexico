...
source("analysis/00_comun.R")   # NIVELES_ESCOLARIDAD

SHP <- "data/external/inegi/MapaBaseMultiescala.gpkg"
...
cat("Guardado: data/processed/geography/municipios_rook.graph\n\n")
