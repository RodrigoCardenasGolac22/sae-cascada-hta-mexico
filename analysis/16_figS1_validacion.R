...
# suplementario -- ver manuscript/manuscript.md "Tablas y figuras"): reduccion de incertidumbre SAE
...
cat("Guardado: results/figures/FigS1_validacion_cruzada.svg y .png\n")
