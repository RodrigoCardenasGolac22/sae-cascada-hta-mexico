...
source("analysis/00_comun.R")   # NIVELES_ESCOLARIDAD, agregar_ponderador_calibrado()
...
ITER <- Sys.getenv("ITER_CSV", unset = "data/external/iter/conjunto_de_datos_iter_00CSV20.csv")
if (!file.exists(ITER)) {
