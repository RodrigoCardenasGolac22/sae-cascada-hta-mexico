...
#    limite superior oficial. Este analisis aplica adicionalmente el techo de plausibilidad
#    PAS <= 270 y PAD <= 180 mmHg implementado abajo; es una decision analitica del estudio.
...
# cinco niveles (sin escolaridad / primaria o menos / secundaria / preparatoria-tecnico / superior).
#
...
source("analysis/00_comun.R")   # NIVELES_ESCOLARIDAD y factorizar_covariables()

DIR <- "data/raw/ensanut"
OUT <- "results/estimates"
YEARS <- 2021:2024
...
# analysis/00_comun.R, que ya se cargo arriba: lo necesitan tambien los scripts 08-12 y no debe estar
