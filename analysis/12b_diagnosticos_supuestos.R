...
source("analysis/00_comun.R")   # cargar_covariables_area(): misma escala de covariables que los modelos

RES <- "results/estimates"; GEO <- "data/processed/geography"; COV <- "data/processed/covariates"
...
cat("\nGuardado: results/estimates/diagnosticos_supuestos.csv y diag_multicolinealidad.csv\n")
