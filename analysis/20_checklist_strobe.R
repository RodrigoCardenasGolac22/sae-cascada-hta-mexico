...
strobe <- data.frame(
  ...
  `Ubicación en el manuscrito` = c(
    ...
    "Resultados > Muestra y Figura 1 (exclusión de presión arterial no válida, embarazo y ponderador faltante, cada una con su n); Materiales y métodos > Modelo estadístico (seis registros de control sin pobreza municipal, por tres municipios creados después del marco CONEVAL 2020; Tabla S1)",
