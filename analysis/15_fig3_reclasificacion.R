...
GEO_SHP <- "data/external/inegi/MapaBaseMultiescala.gpkg"
...
cat("Guardado: results/figures/Fig3_reclasificacion_ESH_vs_AHA.svg y .png\n")

guardar_figura_pptx(fig3, file.path(FIG, "Fig3_reclasificacion_ESH_vs_AHA.pptx"), ancho = 10, alto = 6.3)

# Exportacion para el envio a la revista mexicana (ver analysis/00_comun.R):
...
guardar_datos_figura(datos, file.path(FIG, "data", "Fig3_datos.xlsx"))
